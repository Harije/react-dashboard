...
function AddUser(){
        ...
        const validateForm = () => {
            ...
            axios.post('https://dummyjson.com/users/add',userName,userEmail,userPhno,userPassword )
        ...
        return(
            <section className="forms px-3 py-3 bg-light" id="form" style={{height:"100vh"}}>
                 <Link to="/users" className='text-decoration-none bg-primary text-white py-2 px-3 rounded'>Users</Link>
                <div className="conatiner py-md-3 py-2 px-3">
                    <div className="row m-lg-0 m-3">
                    <h1><span className='text-success'>Sign in</span> to Create a User account</h1>
    
                        <div className="col-lg-4 col-12 py-4 formbg rounded">
                            {/* <h1>Signin to Create a User account</h1> */}
                            <div className="mb-2">
